...
public class BukkitUtils
{
        ...
        static {
                ...
                // Nop, got a way better fix
                //Material ironChests = null;
                //ironChests.addMaterial(975, "X975");
                //containerBlocks.add(ironChests);
        ...
        public static Location getInventoryHolderLocation(InventoryHolder holder) {
                ...
                } else if (holder instanceof org.bukkit.block.Block) {
                        return ((org.bukkit.block.Block)holder).getLocation();
